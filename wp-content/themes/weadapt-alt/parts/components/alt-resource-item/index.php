    ...
    <div class="resources-list__resource-container">
        ...
        <div class="resources-list__resource--text">
            <?php if (!empty($resource_title)) : ?>
                <?php if ($post_type === 'solution') : ?>
                    <a href="<?php echo $resource_url; ?>"><h5 class="resources-list__resource--title"><?php echo $resource_title; ?></h5></a></br>
                <?php else : ?>
                    <a href="<?php echo $resource_url; ?>"><h5 class="resources-list__resource--title"><?php echo $resource_title; ?></h5></a></br>
                <?php endif; ?>
            <?php endif; ?>
            ...
            <?php elseif ($post_type === 'solutions-portal') : ?>
                <div class="resources-list__resource--excerpt">
                    ...
                    // Remove YouTube video links from the content
                    $content_without_video = preg_replace('/https?:\/\/(?:www\.)?(?:youtube\.com\/(?:embed\/|watch\?v=)|youtu\.be\/)[a-zA-Z0-9_-]{11}\S*/', '', $content);
                    echo wp_trim_words($content_without_video, 30, '...');
                    ?>
                </div>
