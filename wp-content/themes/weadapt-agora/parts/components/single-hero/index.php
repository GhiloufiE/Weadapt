		...
		if ( post_type_supports( get_post_type(), 'comments' ) ) {
			...
			$post_meta_items = [
				...
				if ( ! empty( $document_list ) ) {
					$post_meta_items[] = ['icon-download', get_download_count_as_downloads( $file_ID ), 'download-count'];
				}
...
<svg class="hero-svg" viewBox="0 160 1440 160" preserveAspectRatio="none" class="" id="special_wave">
...
<style>
.post-meta__item svg{width : 17px ; height :16px }
