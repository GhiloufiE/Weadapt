...
$name  = 'case-studies-map-alt';
$title = str_replace( '-', ' ', ucfirst( $name ) );

add_filter( 'google_maps_vars_alt', function( $colors = [] ) {
	$colors = [
		'markerColor'      => '#FFFFFF',
		'markerBgColor'    => '#002d75',
...
acf_register_block_type( [
	...
	'enqueue_assets'  => function() use ( $name ) {
		...
		wp_localize_script( "weadapt/$name", 'googleMapsVarsAlt', apply_filters( 'google_maps_vars_alt', [] ) );
	}
] );