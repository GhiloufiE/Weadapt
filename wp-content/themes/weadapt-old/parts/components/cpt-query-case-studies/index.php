<?php
	...
	load_blocks_script( 'cpt-query-case-studies', 'weadapt/cpt-query-case-studies' );
    load_inline_styles( __DIR__, $name );
?>

<div class="cpt-query background-light block-spacing--pt block-spacing--pb">
    <div class="container" >
        <div class="cpt-filters<?php echo ! $show_filters ? ' hidden' : ''; ?>">
        		<form class="cpt-filters__form">
                    ...
                    <div class="cpt-filters__form__search hidden">
                        <input type="search" name="search" placeholder="<?php _e( 'Search...', 'weadapt' ); ?>" value="map" class="cpt-filters__form__input">
