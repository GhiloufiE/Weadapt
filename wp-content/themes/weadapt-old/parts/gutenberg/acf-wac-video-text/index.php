...
$attr = $block_object->attr( 'background-' . get_field( 'background_color' ) . ' ' . $primary_bg .  ' columns-' . $columns . ' media-' . get_field( 'media_position' ) );
...
<section <?php echo $attr; ?>>
	...
	<div class="container">
		<div class="row <?php echo esc_attr( $name ); ?>__row">
			<div class="col-12 col-lg-8 <?php echo esc_attr( $name ); ?>__col <?php echo esc_attr( $name ); ?>__col--video">
				<?php
			...
			<div class="col-12 col-lg-4 <?php echo esc_attr( $name ); ?>__col <?php echo esc_attr( $name ); ?>__col--text">
				<InnerBlocks />
			</div>
		</div>
	</div>
