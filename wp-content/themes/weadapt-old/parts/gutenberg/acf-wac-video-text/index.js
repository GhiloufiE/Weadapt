...
const videoInit = () => {
    const videoSections = document.querySelectorAll('.wac-video-text');

    videoSections.forEach(video => {
        const videoTrigger = video.querySelector('.wac-video-text__video-play');
        const videoPlayer = video.querySelector('iframe') ? video.querySelector('iframe') : video.querySelector('video');
        const videoParent = video.querySelector('.wac-video-text__video');
