...
<section <?php echo $attr; ?>>
	...
	<div class="container smaller-container">
		...
		<div class="<?php echo esc_attr( $name ); ?>__organisations">
			<div class="organisations__row row--ajax <?php echo esc_attr( $name ); ?>__organisations-list" data-offset-organisation="<?php echo $offset_organisation; ?>">
