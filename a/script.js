var zoomTargets = {
    red: { translateXPercent: 50, translateYPercent: 20, scale: 2.5 }, 
    orange: { translateXPercent: 80, translateYPercent: 50, scale: 2.5 },
    green: { translateXPercent: 50, translateYPercent: 80, scale: 2.5 },
    blue: { translateXPercent: 20, translateYPercent: 50, scale: 2.5 },
    rectangle: { translateXPercent: 50, translateYPercent: 50, scale: 2.5 } 
};
